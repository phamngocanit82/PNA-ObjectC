...
@interface CameraDetailController : UIViewController {
...
@interface CameraController () <DBCameraViewControllerDelegate, UITableViewDataSource, UITableViewDelegate> {
...
- (void) openCustomCamera
{
    ...
    CameraNavigationController *nav = [[CameraNavigationController alloc] initWithRootViewController:[[DBCameraViewController alloc] initWithDelegate:self cameraView:camera]];
...
- (void) openCameraWithoutSegue
{
    ...
    CameraNavigationController *nav = [[CameraNavigationController alloc] initWithRootViewController:container];
    [self presentViewController:nav animated:YES completion:nil];
}
...
{
    CameraNavigationController *nav = [[CameraNavigationController alloc] initWithRootViewController:[DBCameraViewController initWithDelegate:self]];
    [self presentViewController:nav animated:YES completion:nil];
}
...
{
    CameraDetailController *detail = [[CameraDetailController alloc] init];
